...
sections:
  - block: hero
    content: 
      title: YWAM Sendai
      text: To know God and make Him known in Northern Japan.
      primary_action:
        text: Apply
        url: /apply/
        icon: sparkles
    ...
    content: 
      ...
      buttons:
        - text: "Send us an email"
          url: "mailto:ywamsendai.info@gmail.com"
          icon: "envelope"
        - text: "Chat with us on Discord"
          url: "https://discord.gg/djmCF4DBaV"
          icon: "discord"
        - text: "Connect on Instagram"
          url: "https://instagram.com/ywamsendai"
          icon: "instagram"
    design:
      columns: "3"
---